...
syn region nsisBooleanOpt	contained start="" end="$" transparent contains=@nsisAnyOpt,nsisBoolean
syn region nsisOnOffOpt		contained start="" end="$" transparent contains=@nsisAnyOpt,nsisOnOff
syn region nsisLangOpt		contained start="" end="$" transparent contains=@nsisAnyOpt,nsisLangKwd
syn match nsisLangKwd		contained "/LANG\>"
syn region nsisFontOpt		contained start="" end="$" transparent contains=@nsisAnyOpt,nsisFontKwd
...
syn region nsisPageOpt		contained start="" end="$" transparent contains=@nsisAnyOpt,nsisPageKwd
...
syn region nsisPageExOpt	contained start="" end="$" transparent contains=@nsisAnyOpt,nsisPageExKwd
...
syn region nsisSectionOpt	contained start="" end="$" transparent contains=@nsisAnyOpt,nsisSectionKwd
syn match nsisSectionKwd	contained "/o\>"

syn keyword nsisStatement	contained SectionIn nextgroup=nsisSectionInOpt skipwhite
syn region nsisSectionInOpt	contained start="" end="$" transparent contains=@nsisAnyOpt,nsisSectionInKwd
...
syn region nsisSectionGroupOpt	contained start="" end="$" transparent contains=@nsisAnyOpt,nsisSectionGroupKwd
...
syn region nsisVarOpt		contained start="" end="$" transparent contains=@nsisAnyOpt,nsisVarKwd
...
syn region nsisAddBrandingImageOpt  contained start="" end="$" transparent contains=@nsisAnyOpt,nsisAddBrandingImageKwd
...
syn region nsisBGGradientOpt	contained start="" end="$" transparent contains=@nsisAnyOpt,nsisBGGradientKwd
...
syn region nsisBrandingTextOpt	contained start="" end="$" transparent contains=@nsisAnyOpt,nsisBrandingTextKwd
...
syn region nsisCRCCheckOpt	contained start="" end="$" transparent contains=@nsisAnyOpt,nsisCRCCheckKwd
...
syn region nsisDirVerifyOpt	contained start="" end="$" transparent contains=@nsisAnyOpt,nsisDirVerifyKwd
...
syn region nsisInstallColorsOpt	contained start="" end="$" transparent contains=@nsisAnyOpt,nsisInstallColorsKwd
...
syn region nsisInstTypeOpt	contained start="" end="$" transparent contains=@nsisAnyOpt,nsisInstTypeKwd
...
syn region nsisLicenseBkColorOpt contained start="" end="$" transparent contains=@nsisAnyOpt,nsisLicenseBkColorKwd
...
syn region nsisLicenseForceSelectionOpt  contained start="" end="$" transparent contains=@nsisAnyOpt,nsisLicenseForceSelectionKwd
...
syn region nsisManifestDPIAwareOpt	contained start="" end="$" transparent contains=@nsisAnyOpt,nsisManifestDPIAwareKwd
...
syn region nsisManifestSupportedOSOpt	contained start="" end="$" transparent contains=@nsisAnyOpt,nsisManifestSupportedOSKwd
...
syn region nsisRequestExecutionLevelOpt  contained start="" end="$" transparent contains=@nsisAnyOpt,nsisRequestExecutionLevelKwd
...
syn region nsisShowInstDetailsOpt  contained start="" end="$" transparent contains=@nsisAnyOpt,nsisShowInstDetailsKwd
...
syn region nsisSilentInstallOpt	 contained start="" end="$" transparent contains=@nsisAnyOpt,nsisSilentInstallKwd
...
syn region nsisSilentUnInstallOpt  contained start="" end="$" transparent contains=@nsisAnyOpt,nsisSilentUnInstallKwd
...
syn region nsisSetCompressOpt	contained start="" end="$" transparent contains=@nsisAnyOpt,nsisSetCompressKwd
...
syn region nsisSetCompressorOpt	contained start="" end="$" transparent contains=@nsisAnyOpt,nsisSetCompressorKwd
...
syn region nsisSetOverwriteOpt	contained start="" end="$" transparent contains=@nsisAnyOpt,nsisSetOverwriteKwd
...
syn region nsisDeleteOpt	contained start="" end="$" transparent contains=@nsisAnyOpt,nsisDeleteKwd
...
syn region nsisFileOpt		contained start="" end="$" transparent contains=@nsisAnyOpt,nsisFileKwd
...
syn region nsisDeleteRegKeyOpt	contained start="" end="$" transparent contains=@nsisAnyOpt,nsisDeleteRegKeyKwd,nsisRegistry
...
syn region nsisRegistryOpt	contained start="" end="$" transparent contains=@nsisAnyOpt,nsisRegistry

syn keyword nsisInstruction	contained WriteRegMultiStr nextgroup=nsisWriteRegMultiStrOpt skipwhite
syn region nsisWriteRegMultiStrOpt contained start="" end="$" transparent contains=@nsisAnyOpt,nsisRegistry,nsisWriteRegMultiStrKwd
...
syn region nsisSetRegViewOpt	contained start="" end="$" transparent contains=@nsisAnyOpt,nsisSetRegViewKwd
...
syn region nsisCopyFilesOpt	contained start="" end="$" transparent contains=@nsisAnyOpt,nsisCopyFilesKwd
...
syn region nsisCreateShortcutOpt contained start="" end="$" transparent contains=@nsisAnyOpt,nsisCreateShortcutKwd
...
syn region nsisGetFullPathNameOpt contained start="" end="$" transparent contains=@nsisAnyOpt,nsisGetFullPathNameKwd
...
syn region nsisSetFileAttributesOpt  contained start="" end="$" transparent contains=@nsisAnyOpt,nsisFileAttrib
...
syn region nsisFileWriteUTF16LEOpt contained start="" end="$" transparent contains=@nsisAnyOpt,nsisFileWriteUTF16LEKwd
...
syn region nsisSetShellVarContextOpt  contained start="" end="$" transparent contains=@nsisAnyOpt,nsisSetShellVarContextKwd
...
syn region nsisSendMessageOpt	contained start="" end="$" transparent contains=@nsisAnyOpt,nsisSendMessageKwd
...
syn region nsisSetBrandingImageOpt contained start="" end="$" transparent contains=@nsisAnyOpt,nsisSetBrandingImageKwd
...
syn region nsisSetDetailsViewOpt	contained start="" end="$" transparent contains=@nsisAnyOpt,nsisSetDetailsViewKwd
...
syn region nsisSetDetailsPrintOpt	contained start="" end="$" transparent contains=@nsisAnyOpt,nsisSetDetailsPrintKwd
...
syn region nsisSetCtlColorsOpt	contained start="" end="$" transparent contains=@nsisAnyOpt,nsisSetCtlColorsKwd
...
syn region nsisSetSilentOpt	contained start="" end="$" transparent contains=@nsisAnyOpt,nsisSetSilentKwd
...
syn region nsisIncludeOpt	contained start="" end="$" transparent contains=@nsisAnyOpt,nsisIncludeKwd
...
syn region nsisAddplugindirOpt	contained start="" end="$" transparent contains=@nsisAnyOpt,nsisAddplugindirKwd
...
syn region nsisAppendfileOpt	contained start="" end="$" transparent contains=@nsisAnyOpt,nsisAppendfileKwd
...
syn region nsisDelfileOpt	contained start="" end="$" transparent contains=@nsisAnyOpt,nsisDelfileKwd
...
syn region nsisPragmaOpt	contained start="" end="$" transparent contains=@nsisAnyOpt,nsisPragmaKwd
...
syn region nsisVerboseOpt	contained start="" end="$" transparent contains=@nsisAnyOpt,nsisVerboseKwd
...
syn region nsisDefineOpt	contained start="" end="$" transparent contains=@nsisAnyOpt,nsisDefineKwd
...
syn region nsisIfOpt		contained start="" end="$" transparent contains=@nsisAnyOpt,nsisIfKwd
...
syn region nsisSearchparseOpt	contained start="" end="$" transparent contains=@nsisAnyOpt,nsisSearchparseKwd
...
syn region nsisSearchreplaceOpt	contained start="" end="$" transparent contains=@nsisAnyOpt,nsisSearchreplaceKwd
